...
def main():
    ...
    while True:
        ...
        view._draw_menu(screen)
        
        view._draw_background(screen)

        view._draw_game_area(screen, game_area)

        view._draw_gridlines(screen)

        view._draw_info(screen, font1, font_pos_x, font1_height, score)
        # 画显示信息中的下一个方块
        view._draw_block(screen, next_block, font_pos_x,50 + (font1_height + 6) * 7, 0, 0)
        ...
        # 画当前下落方块
        view._draw_block(screen, cur_block, 0, 0, cur_pos_x, cur_pos_y)
